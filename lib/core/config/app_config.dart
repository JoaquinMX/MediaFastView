...
class AppConfig {
  ...
  /// Get the minimum duration allowed for slideshow slides.
  ...
  /// Set the minimum duration allowed for slideshow slides.
  static set slideshowMinDuration(Duration value) {
    _prefs?.setInt(_slideshowMinDurationKey, value.inMilliseconds);
  }

  /// Get the maximum duration allowed for slideshow slides.
  ...
  /// Set the maximum duration allowed for slideshow slides.
