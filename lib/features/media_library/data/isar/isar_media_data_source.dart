...
///
/// The implementation keeps parity with the previous persistence API so
/// repositories and use cases can operate entirely on the Isar-backed store.
/// It leverages [DirectoryCollectionStore] to attach link relationships while
/// storing media records.
